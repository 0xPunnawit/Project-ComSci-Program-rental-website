...
public class ProductsController {
    ...
    public Object downloadFile(@PathVariable Long id, HttpSession session, Model model) {
        ...
        String fileName = productService.getFilePath(id.intValue());

        try {
            // สร้าง path ที่รองรับทุกเครื่อง
            String uploadDir = new File("uploaded").getAbsolutePath();
            Path fullPath = Paths.get(uploadDir, fileName).toAbsolutePath().normalize();
            Resource resource = new UrlResource(fullPath.toUri());

            if (!resource.exists()) {
                model.addAttribute("errorMessage", "ไม่พบไฟล์ที่ต้องการดาวน์โหลด");
                return "error";
            }
    ...
    public String addProduct(
            ...
            @RequestParam(value = "youtubeUrl", required = false, defaultValue = "") String youtubeUrl,
        ...
        try {
            ...
            // String uploadDir = "D:/ProjectCs-SpringBoot-main/src/main/resources/files/"; // Hardcoded path
            String uploadDir = new File("uploaded").getAbsolutePath() + File.separator;
...
//                String uploadDir = "D:/ProjectCs-SpringBoot-main/src/main/resources/files/"; // Hardcode path
                String uploadDir = new File("uploaded").getAbsolutePath() + File.separator;
                String fileName = fileProgram.getOriginalFilename();
                ...
                product.setFileProgram(fileName);
            }
